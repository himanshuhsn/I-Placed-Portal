...
<div class="card-body bg-light">
   ...
   <button id ="btn-approve-${num}" type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#exampleModal-${num}   ">Approve</button>
   <button id ="btn-deny-${num}" type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#exampleModal-${num}   ">Deny</button>
  ...
  datas = [
    {
      email: "gagan@j.com",
      level: "medium",
      rounds: { round_1: { question_1: "very ez" } },
      lastName: "Singh",
      batch: "2018",
      feedback: "very ez",
      status: "selected",
      company: "Paytm",
      tags: ["Hash", "Linked List", "palindrome"],
      cgpa: "8.9",
      firstName: "Gagandeep",
    },
    {
      tags: [],
      feedback:
        "They generally asked medium leetcode questions. Please be through with the leetcode medium level questions.",
      cgpa: "8.10",
      lastName: "Nayak",
      rounds: {
        round_1: {
          question_2: "Select SQL command that uses group by command.",
          question_1: "How to add two numbers without using + operator ?",
        },
      },
      firstName: "Himanshu Sekhar",
      level: "easy",
      batch: "2018",
      email: "himanshun@iitbhilai.ac.in",
      status: "selected",
    ...
    },
    {
      ...
      level: "easy",
      rounds: {
        round_2: { question_1: "Basic interaction." },
        round_1: {
          question_2: "Hr question.",
          question_1: "question on palindrome.",
        },
      },
      firstName: "Test ",
      email: "test@user.com",
    ...
    },
    {
      ...
      batch: "2018",
      lastName: "Chaudhary",
      rounds: { round_1: { question_1: "Basic interactive questions." } },
      feedback: "good",
    },
    {
      firstName: "Swapnil",
      ...
      rounds: {
        round_2: { question_1: "HR round questions." },
        round_1: {
          question_2: "question on linked list.",
          question_1: "Question on arrays.",
        },
      },
      batch: "2018",
      email: "swapnilnarad2000@gmail.com",
      feedback: "Good experience.",
      lastName: "Narad",
      level: "easy",
      company: "LTI",
    ...
    {
      rounds: { round_1: { question_1: "Height of tree" } },
      status: "selected",
      cgpa: "8.8",
      firstName: "Vivek",
      ...
      feedback: "",
      lastName: "Singh",
      email: "viveks@iitbhilai.ac.in",
      company: "OYO Rooms",
      level: "medium",
    },
    {
      email: "himanshu000666@gmail.com",
      feedback: "good.",
      firstName: "Himanshu",
      status: "selected",
      company: "Flipkart",
      batch: "2018",
      lastName: "Nayak",
      tags: ["AVL-Tree", "Strings"],
      rounds: {
        round_1: {
          question_1: "question on strings.",
          question_2: "question on arrays.",
        },
      },
      level: "easy",
      cgpa: "8",
    ...
    {
      status: "selected",
      email: "chirap@iitbhilai.ac.in",
      lastName: "Poonia",
      rounds: {
        round_1: {
          question_3: "Tree question for 3rd largest element",
          question_2: "Sliding window",
          question_1: "2 pointer",
        },
      },
      cgpa: "8.5",
      tags: ["Tree", "two-pointer-algorithm", "sliding-window"],
      batch: "2018",
      feedback: "",
      level: "medium",
      firstName: "Chirag",
    ...
    },
    {
      ...
      tags: ["Hash"],
      company: "Microsoft",
      rounds: { round_1: { question_1: "dscac" } },
      status: "selected",
      level: "easy",
      lastName: "nikhil",
      firstName: "siram",
    ...
    },
    {
      ...
      company: "VMWare",
      lastName: "user 3",
      rounds: { round_1: { question_1: "test" } },
    },
    {
      level: "hard",
      status: "not_selected",
